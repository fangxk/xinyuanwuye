define(['jquery', 'bootstrap', 'backend', 'table', 'form','jstree'], function ($, undefined, Backend, Table, Form, undefined) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                ...
                extend: {
                    ...
                    suminfo_url: 'property/question/suminfo',
        ...
        suminfo:function(){
            Controller.api.bindevent();
            $("#sedata").click(function () {
                if ($("#treeview").size() > 0) {
                    var r = $("#treeview").jstree("get_all_checked");
                    $("input[name='reginonid']").val(r.join(','));
                    var shuju =  $("input[name='reginonid']").val();
                    $("#formdata").submit();
                }
            });
            //导出数据
            $("#explord").click(function () {
                var url = "/admin.php/property/question/suminfos";
                var r = $("#treeview").jstree("get_all_checked");
                $("input[name='reginonid']").val(r.join(','));
                var shuju =  $("input[name='reginonid']").val();
                ...
                $.ajax({
                    ...
                    data:{shuju:shuju},
                    success:function () {
                        window.location.href="/admin.php/property/question/suminfo/ids/"+ids+"/explort/1";
                    }
                });
            });
        },
        questionshow:function(){
            ...
            //导出数据
            $("#explord").click(function () {
                var url = "/admin.php/property/question/questionshows";
                var r = $("#treeview").jstree("get_all_checked");
                $("input[name='reginonid']").val(r.join(','));
                var shuju =  $("input[name='reginonid']").val();
                ...
                $.ajax({
                    url:url,
                    type:"post",
                    data:{shuju:shuju,keyword:keyword},
                    success:function () {
                        window.location.href="/admin.php/property/question/questionshow/ids/"+ids+"/explort/1";
                    }
                });
            });
        },
