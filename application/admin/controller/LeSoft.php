 ...
 */
class LeSoft extends Backend
{
    protected $noNeedLogin = '*';
    protected $noNeedRight = '*';

    protected $appId = "2019010117";//2019010117
    protected $appSecret = "EE58DCB20F64036C349D6BEEC800A344";//EE58DCB20F64036C349D6BEEC800A344
    protected $accountCode = "xywy";//xywy
    ...
    public function GetSign($data){
        ...
        $params= urldecode($param."&key=".$this->appSecret);
        $res = strtolower(md5($params));
        return $res;
    }
